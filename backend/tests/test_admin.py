...
@pytest.mark.anyio
async def test_load_minimal_xml_success(client: AsyncClient, admin_headers: dict):
...
@pytest.mark.anyio
async def test_load_xml_wrong_content_type(client: AsyncClient, admin_headers: dict):
...
@pytest.mark.anyio
async def test_load_xml_empty_file(client: AsyncClient, admin_headers: dict):
...
@pytest.mark.anyio
async def test_load_xml_invalid_xml(client: AsyncClient, admin_headers: dict):
...
@pytest.mark.anyio
async def test_load_gedcom_empty_file(client: AsyncClient, admin_headers: dict):
...
@pytest.mark.anyio
async def test_load_gedcom_invalid_encoding(client: AsyncClient, admin_headers: dict):
...
@pytest.mark.anyio
async def test_load_photos_not_zip(client: AsyncClient, admin_headers: dict):
